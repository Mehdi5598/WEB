...
Route::put('/pilote/{pilote}/update', [PiloteController::class, 'update'])->name('pilote.update');
Route::delete('/pilote/{pilote}/destroy', [PiloteController::class, 'destroy'])->name('pilote.destroy');
